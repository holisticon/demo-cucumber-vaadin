...
public class TimeTrackingEditor extends CustomComponent {
	...
	public TimeTrackingEditor() {
		...
		form.setFormFieldFactory(new FormFieldFactory() {
			...
			public Field createField(Item item, Object propertyId, Component uiContext) {
				...
				if (pid.equals("timeFrom")) {
					DateField dateField = new DateField("von:");
					return dateField;
				}
				if (pid.equals("timeUntil")) {
					DateField dateField = new DateField("bis:");
					return dateField;
				}
				if (pid.equals("description")) {
					TextField textField = new TextField("Tätigkeit:");
					return textField;
				}
		...
		buttonBar.addComponent(new Button("Speichern", new Button.ClickListener() {
