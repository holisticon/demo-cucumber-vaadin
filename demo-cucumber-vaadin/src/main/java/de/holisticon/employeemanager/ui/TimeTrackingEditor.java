...
public class TimeTrackingEditor extends CustomComponent {
	...
	public TimeTrackingEditor() {
		...
		final Form recordForm = new TimeTrackingForm();
		recordForm.setItemDataSource(new BeanItem<TimeTrackingRecord>(record));
		timeTrackingEditorPanel.addComponent(recordForm);
